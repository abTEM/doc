# {py:mod}`abtem.bloch.dynamical`

```{py:module} abtem.bloch.dynamical
```
...
````{py:data} AllowedRotations
:canonical: abtem.bloch.dynamical.AllowedRotations
:value: >
   None
...
````{py:property} cell
:canonical: abtem.bloch.dynamical.BaseStructureFactor.cell
:abstractmethod:
:type: ase.cell.Cell
...
:canonical: abtem.bloch.dynamical.BaseStructureFactor.centering
:type: str
...
````{py:property} device
:canonical: abtem.bloch.dynamical.BaseStructureFactor.device
:abstractmethod:
:type: str
...
````{py:property} g_max
:canonical: abtem.bloch.dynamical.BaseStructureFactor.g_max
:type: float
...
````{py:property} g_vec
:canonical: abtem.bloch.dynamical.BaseStructureFactor.g_vec
:type: numpy.ndarray
...
````{py:property} g_vec_length
:canonical: abtem.bloch.dynamical.BaseStructureFactor.g_vec_length
:type: numpy.ndarray
...
:canonical: abtem.bloch.dynamical.BaseStructureFactor.get_potential_3d
:abstractmethod:
...
````{py:property} gpts
:canonical: abtem.bloch.dynamical.BaseStructureFactor.gpts
...
````{py:property} hkl
:canonical: abtem.bloch.dynamical.BaseStructureFactor.hkl
:type: numpy.ndarray
...
````{py:property} cell
:canonical: abtem.bloch.dynamical.BlochWaves.cell
:type: ase.cell.Cell
...
````{py:property} device
:canonical: abtem.bloch.dynamical.BlochWaves.device
:type: str
...
````{py:property} energy
:canonical: abtem.bloch.dynamical.BlochWaves.energy
:type: float
...
````{py:method} excitation_errors() -> numpy.ndarray
...
````{py:property} g_max
:canonical: abtem.bloch.dynamical.BlochWaves.g_max
:type: float
...
````{py:property} g_vec
:canonical: abtem.bloch.dynamical.BlochWaves.g_vec
:type: numpy.ndarray
...
````{py:property} g_vec_length
:canonical: abtem.bloch.dynamical.BlochWaves.g_vec_length
:type: numpy.ndarray
...
````{py:property} hkl
:canonical: abtem.bloch.dynamical.BlochWaves.hkl
:type: numpy.ndarray
...
````{py:property} hkl_mask
:canonical: abtem.bloch.dynamical.BlochWaves.hkl_mask
:type: numpy.ndarray
...
````{py:property} num_bloch_waves
:canonical: abtem.bloch.dynamical.BlochWaves.num_bloch_waves
:type: int
...
````{py:property} sg_max
:canonical: abtem.bloch.dynamical.BlochWaves.sg_max
:type: float
...
````{py:property} structure_factor
:canonical: abtem.bloch.dynamical.BlochWaves.structure_factor
...
````{py:property} structure_matrix_nbytes
:canonical: abtem.bloch.dynamical.BlochWaves.structure_matrix_nbytes
:type: int
...
````{py:property} use_wave_eq
:canonical: abtem.bloch.dynamical.BlochWaves.use_wave_eq
:type: bool
...
:canonical: abtem.bloch.dynamical.BlochWaves.wavelength
:type: float
...
````{py:property} axes
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.axes
...
````{py:property} centering
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.centering
:type: str
...
````{py:property} device
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.device
:type: str
...
````{py:property} energy
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.energy
:type: float
...
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.ensemble_axes_metadata
:type: list[abtem.core.axes.AxisMetadata]

````

````{py:property} ensemble_shape
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.ensemble_shape
:type: tuple[int, ...]

````

````{py:property} g_max
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.g_max
:type: float
...
````{py:method} get_ensemble_hkl_mask() -> numpy.ndarray
...
````{py:method} get_orientation_matrices() -> numpy.ndarray
...
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.rotations
...
````{py:property} sg_max
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.sg_max
:type: float
...
````{py:property} structure_factor
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.structure_factor
:type: abtem.bloch.dynamical.BaseStructureFactor
...
````{py:property} use_degrees
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.use_degrees
:type: bool
...
````{py:property} use_wave_eq
:canonical: abtem.bloch.dynamical.BlochwaveEnsemble.use_wave_eq
:type: bool
...
````{py:property} atoms
:canonical: abtem.bloch.dynamical.StructureFactor.atoms
:type: ase.Atoms
...
````{py:method} calculate_scattering_factors() -> numpy.ndarray
...
````{py:property} cell
:canonical: abtem.bloch.dynamical.StructureFactor.cell
:type: ase.cell.Cell

````

````{py:property} device
:canonical: abtem.bloch.dynamical.StructureFactor.device
:type: str
...
````{py:property} g_max
:canonical: abtem.bloch.dynamical.StructureFactor.g_max
:type: float
...
````{py:property} occupancy
:canonical: abtem.bloch.dynamical.StructureFactor.occupancy
...
:canonical: abtem.bloch.dynamical.StructureFactor.parametrization
...
````{py:property} thermal_sigma
:canonical: abtem.bloch.dynamical.StructureFactor.thermal_sigma
:type: numpy.ndarray | dict[str, numpy.ndarray]
...
````{py:property} cell
:canonical: abtem.bloch.dynamical.StructureFactorArray.cell
:type: ase.cell.Cell
...
````{py:property} gpts
:canonical: abtem.bloch.dynamical.StructureFactorArray.gpts
:type: tuple[int, int, int]
...
````{py:method} to_3d_array() -> numpy.ndarray

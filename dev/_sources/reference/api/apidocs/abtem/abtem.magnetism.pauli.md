# {py:mod}`abtem.magnetism.pauli`

```{py:module} abtem.magnetism.pauli
```

```{autodoc2-docstring} abtem.magnetism.pauli
:allowtitles:
```
...
* - {py:obj}`central_difference_gradient_pbc <abtem.magnetism.pauli.central_difference_gradient_pbc>`
  - ```{autodoc2-docstring} abtem.magnetism.pauli.central_difference_gradient_pbc
    :summary:
    ```
* - {py:obj}`central_difference_gradient_cbc <abtem.magnetism.pauli.central_difference_gradient_cbc>`
  - ```{autodoc2-docstring} abtem.magnetism.pauli.central_difference_gradient_cbc
    :summary:
    ```
* - {py:obj}`apply_A_xy_dot_nabla_xy <abtem.magnetism.pauli.apply_A_xy_dot_nabla_xy>`
